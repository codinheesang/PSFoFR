...
# 3D plot, Regression function Estimate, Significant area Plot For Japan Data
...
graph<-ggplot(data, aes(X, Y, fill= Z)) + 
  ...
  scale_y_continuous(labels=c('22/07', '22/09', '22/11', '23/01', "23/04", "23/06"))+
  geom_tile()
...
#title("Estimated functional coefficient")
